...
const Skill = ({ name, x, y }) => {
    return (
        <motion.div
            className='absolute cursor-pointer flex items-center justify-center rounded-full font-semibold bg-dark dark:bg-light text-light dark:text-dark py-4 px-8 shadow-dark'
